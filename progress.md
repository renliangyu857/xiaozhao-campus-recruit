...
### Git提交
- **Commit:** `fc37c84` feat: 接入微信Native支付（扫码支付）
...
在部署前，需要在 `.env.local` 或生产环境配置以下变量：
...
### 2026-03-10
- ����΢��֧��/��¼Ѳ�죬���� `payment/create`��`payment/notify`��`auth/qrcode/poll`��`wechat/callback` �ȹؼ�·����
- ���޸�֧����Ч�ڲ�һ�¡����Ϲ���ص��ݵȡ�PC ɨ���¼ȱ�� API Secret Cookie�����϶������ƶ�ʧ�����⡣
- ��ͬ������ `docs/΢�ŵ�¼����˵��.md`���Ƴ���ʵ����ʾ������Ϊռλ����
- ����У�飺`npx eslint` ��ͨ������ Markdown �ļ��� ESLint ���ԣ���`npx tsc --noEmit` �Ա����� E2E ���� `test.request` ���ʹ���������δ�����θĶ�����������
- ���޸� 4 �� API E2E ������ Playwright `request` ������������Ϊ `APIRequestContext`����`npx tsc --noEmit` �붨�� `npx eslint` ����ͨ����

### 2026-03-12
- ʹ�� `planning-with-files` ����΢��֧�������ݽ�����
- ���ۣ�֧����·��Ҫ����ṹ����־���澯���û��ඩ����¼���ġ�
- �ѽ�����ʵʩ��Ϊ���ࣺ����˿ɹ۲��ԣ���־/�澯/���������û��˿ɻ����ԣ������б�/����/ˢ��״̬����
- ����ִ��˳������־��澯���ٶ�����¼ҳ�棬������˿����Ϣ֪ͨ��
- �ѿ�ʼ��ص�һ��֧���ɹ۲����붩�����ģ�����֧��������־�������б� API�������б�ҳ������ҳ��������ڽ��뵼����
